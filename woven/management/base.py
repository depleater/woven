...
class WovenCommand(BaseCommand):
    option_list = BaseCommand.option_list + (
        make_option('--noinput', action='store_false',
                dest='interactive',
                default=True,
                help='Do NOT prompt for input (except ' \
        ...
        make_option('--setup',
                help='The /path/to/dir containing the setup.py module. ' \
                    'The command will execute from this directory. Only ' \
                    'required if you are not executing the command from ' \
                    'below the setup.py directory',
                ),
